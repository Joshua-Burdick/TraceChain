                ...
                flex flex-col lg:flex-row -mt-10 space-x-0 lg:space-x-10">
                        ...
                        <form @submit.prevent="updateAccount">
                            <div class="mb-4">
                                ...
                                <input 
                                    ...
                                    py-2 px-3 leading-tight mb-4 text-white"
                                >
                                <!--Username-->
                            ...
                            <div class="flex justify-center items-center mt-4 space-x-4">
                                <button type="submit" class="bg-green-800 px-4 py-2 rounded-md text-sm font-bold text-white">Save Changes</button>
                                <button @click="showDeleteConfirmation" type="button" class="bg-red-800 px-4 py-2 rounded-md font-bold text-sm text-white">Delete Account</button>
                            </div>
                        </form>
                    </div>
                    <!--Profile Picture-->
                    <div class="flex flex-col items-center justify-center lg:flex-1">
                        ...
                        <button
                          fill="solid"
                          color="light"
                          class="mt-6 bg-neutral-700 py-2 px-4 font-bold rounded-md text-sm text-white"
